...
const AVAILABILITY_TEMPORARY_APPLY_VERSION = "20260901-1";
    ...
    .on("head", {
      element(element) {
        element.append(
          ...
          `<link rel="stylesheet" href="/admin/availability-temporary-apply.css?v=${AVAILABILITY_TEMPORARY_APPLY_VERSION}" data-sdlive-availability-temporary-apply/>` +
          ...
          `<script defer src="/admin/availability-temporary-apply.js?v=${AVAILABILITY_TEMPORARY_APPLY_VERSION}" data-sdlive-availability-temporary-apply></script>`,
          { html: true }
        );
      }
    })
