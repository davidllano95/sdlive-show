...
test('Travel Mode Admin UI is part of the existing Availability card and remains mobile-safe', () => {
  ...
  assert.match(edge, /AVAILABILITY_ADMIN_RUNTIME_VERSION = "20260901-4"/);
